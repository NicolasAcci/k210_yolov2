    ...
    if weights == 'imagenet':
        ...
        if include_top:
            ...
            weights_path = keras_utils.get_file(model_name,
                                                ...
                                                cache_subdir='models')
        if alpha==1.0:
            weightss='mobilenet_1_0_224_tf_no_top.h5'
        elif alpha==0.75:
            weightss='mobilenet_7_5_224_tf_no_top.h5'
        elif alpha==0.50:
            weightss='mobilenet_5_0_224_tf_no_top.h5'
        elif alpha==0.25:
            weightss='mobilenet_2_5_224_tf_no_top.h5'
